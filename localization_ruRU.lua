...
_L.yells[886]["Lei Shi"] =
    "Я... а... о! Я?.. Все было таким... мутным."
_L.yells[886]["Tsulong"] =
    "Спасибо вам, незнакомцы. Я свободен."

-- Yells/Siege_of_Orgrimmar
--[[Translation missing --]]
_L.yells[953]["Immerseus"] =
    "Ah, you have done it!  The waters are pure once more."
--[[Translation missing --]]
...
MRT_L.Core["DKP_Frame_LootetBy"] =
    "|cFFFFFFFF%s|r получает добычу."
...
MRT_L.Core["Export_AttendanceNote"] =
    [=[In the Raid-Log-Import-Settings, please set the option
...
MRT_L.Core["Export_Explanation"] =
    [=[Нажмите Ctrl+C чтобы скопировать данные в буфер обмена.
...
MRT_L.Options["AP_GuildAttendanceUseCustomText"] =
    "Использовать другой текст для проверки присутствия"
MRT_L.Options["AP_GuildAttendanceUseTrigger"] =
    "Использовать триггер вместо имени персонажа"
MRT_L.Options["AP_Minutes"] = "минут"
MRT_L.Options["AP_Title"] = "Участники"
MRT_L.Options["AP_TitleText"] = " Опции участников"
MRT_L.Options["AP_TrackOfflinePlayers"] =
    "Отслеживать оффлайн игроков"
MRT_L.Options["EP_AllXMLExportsTitle"] =
    "Все форматы экспорта XML"
...
MRT_L.Options["EP_TextExportTitleText"] =
    "Настр. текста при экспорте"
MRT_L.Options["EP_Title"] = "Экспорт"
MRT_L.Options["EP_TitleText"] = " Экспорт - опции"
...
MRT_L.Options["TP_AskForDKPValuePersonal"] =
    "...если настройки персональной добычи"
MRT_L.Options["TP_CreateNewRaidOnNewZone"] =
    "Создать новый рейд в новой зоне"
...
MRT_L.Options["TP_LogLootModePersonal"] =
    "Отслеживать персональную добычи"
--[[Translation missing --]]
...
MRT_L.Options["TT_EP_AddPoorItem"] =
    [=[Эта опция исправляет запись рейдов для CT_RaidTrackerImport.
...
MRT_L.Options["TT_EP_RLIAttendanceFix"] =
    [=[This option changes the export of timestamps a bit to pass
...
MRT_L.Options["TT_MP_SlashCmd"] =
    [=[Убрать косую черту перед командой.
...
MRT_L.GUI["Active raid found. End current one first."] =
    "Ошибка: Обнаружен активный рейд. Пожалуйста завершите активный рейд прежде чем создавать новый."
MRT_L.GUI["Add boss attendee"] =
    "Добавить участника на босса"
MRT_L.GUI["Add bosskill"] = "Добавить убийство босса"
MRT_L.GUI["Add loot data"] = "Добавить добычу"
MRT_L.GUI["Add raid attendee"] =
    "Добавить участника в рейд"
MRT_L.GUI["Bossname"] = "Имя босса"
MRT_L.GUI["Button_Add"] = "Добавить"
MRT_L.GUI["Button_Delete"] = "Удалить"
MRT_L.GUI["Button_EndCurrentRaid"] =
    "Закончить текущий рейд"
...
MRT_L.GUI["Button_MakeGuildAttendanceCheck"] =
    "Сделать запрос на присутствие"
MRT_L.GUI["Button_Modify"] = "Изменить"
MRT_L.GUI["Button_ResumeLastRaid"] =
    "Восстановить последний рейд"
...
MRT_L.GUI["Can not delete current raid"] =
    "Ошибка: невозможно удалить текущий рейд."
...
MRT_L.GUI["Confirm boss attendee entry deletion"] =
    "Хотите удалить %s из списка участников на боссе?"
MRT_L.GUI["Confirm boss entry deletion"] =
    "Удалить %d - %s - из списка убийства?"
MRT_L.GUI["Confirm loot entry deletion"] =
    "Вы действительно хотите удалить предмет %s из списка добычи?"
MRT_L.GUI["Confirm raid attendee entry deletion"] =
    "Удалить %s из списка посещаемости?"
MRT_L.GUI["Confirm raid entry deletion"] =
    "Вы действительно хотите удалить рейд %d?"
MRT_L.GUI["Difficulty N or H"] = "Сложность ('N' or 'H')"
MRT_L.GUI["End tracking of current raid before exporting it"] =
    "Ошибка. Не возможно экспортировать открытый рейд"
MRT_L.GUI["Entered join time is not before leave time"] =
    "Время присоединения к рейду должно быть меньше времени выхода из рейда."
MRT_L.GUI["Entered time is not between start and end of raid"] =
    "Введенное значение времени не находится в диапазоне времени рейда"
MRT_L.GUI["Header_Title"] = " Лог рейда"
MRT_L.GUI["Item cost invalid"] =
    "Ошибка: неправильная стоимость предмета"
MRT_L.GUI["Itemlink"] =
    "Ссылка на предмет или ID предмета или имя предмета"
...
MRT_L.GUI["No active raid in progress. Please enter time."] =
    "Ошибка: нет активного рейда. Пожалуйста введите время."
MRT_L.GUI["No active raid."] =
    "Ошибка: нет активного рейда"
MRT_L.GUI["No boss attendee selected"] =
    "Ошибка: Нет выделенного босса"
MRT_L.GUI["No boss name entered"] =
    "Ошибка: не введено имя босса"
MRT_L.GUI["No boss selected"] = "Ошибка: босс не выбран"
MRT_L.GUI["No itemLink found"] =
    "Ошибка: ссылка на предмет неверна"
...
MRT_L.GUI["No raid attendee selected"] =
    "Ошибка: Нет выделенного рейда"
MRT_L.GUI["No raid selected"] = "Ошибка: не выбран рейд"
MRT_L.GUI["No valid difficulty entered"] =
    "Ошибка: введена неправильная сложность"
MRT_L.GUI["No valid raid size"] =
    "Ошибка. Введите размер рейда"
MRT_L.GUI["No valid time entered"] =
...
MRT_L.GUI["Resuming last raid failed"] =
    "Ошибка: Последний рейд не восстановлен"
MRT_L.GUI["Resuming last raid successful"] =
    "Последний рейд восстановлен"
...
время начала рейда.]=]
MRT_L.GUI["TT_Attendee_Add_LeaveEB"] =
    [=[Время в формате ЧЧ:ММ.

Если поле пустое, MRT будет выставлять
время окончания рейда.]=]
MRT_L.GUI["TT_BA_Add"] = "Добавить в список"
MRT_L.GUI["TT_BA_Delete"] =
    "Удалить выделенного  из списка"
...
MRT_L.GUI["TT_Boss_Delete"] =
    "Удалить выделенного босса из списка"
MRT_L.GUI["TT_Boss_Export"] =
    "Экспортировать выделенное"
MRT_L.GUI["TT_Loot_Add"] = "Добавить добычу в список"
MRT_L.GUI["TT_Loot_Delete"] = "Удалить добычу"
MRT_L.GUI["TT_Loot_Modify"] =
    "Изменить стоимость или получателя, добавить заметку"
MRT_L.GUI["TT_RA_Add"] = "Добавить в список"
MRT_L.GUI["TT_RA_Delete"] =
    "Убрать участника из списка замен."
MRT_L.GUI["TT_Raid_Delete"] = "Удалить выбранный рейд"
MRT_L.GUI["TT_Raid_Export"] =
    "Экспортировать выбранный рейд"
MRT_L.GUI["TT_Raid_ExportH"] =
    "Экспортировать все бои с боссами в героическом режиме"
MRT_L.GUI["TT_Raid_ExportN"] =
    "Экспортировать все бои с боссами в обычном режиме"
MRT_L.GUI["TT_StartNewRaid_RaidSizeEB"] =
    "Если поле пустое, MRT будет использовать значение 25."
MRT_L.GUI["TT_StartNewRaid_ZoneNameEB"] =
    "если оставить чистым, MRT использует текущую зону"
MRT_L.GUI["TT_TakeSnapshot"] =
    [=[Сделать снимок текущей рейдовой группы.
