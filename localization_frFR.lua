...
_L.yells[529]["Freya"] =
    "Son emprise sur moi se dissipe. J'y vois à nouveau clair. Merci, héros."
_L.yells[529]["Hodir"] = "Je suis... libéré de son emprise... enfin."
_L.yells[529]["Mimiron"] =
    "Il semblerait que j'aie pu faire une minime erreur de calcul."
_L.yells[529]["Thorim"] = "Retenez vos coups ! Je me rends !"

-- Yells/Trials_of_the_Crusader
_L.yells[543]["Faction Champions"] =
    "Une victoire tragique et depourvue de sens. La perte subie aujourd'hui nous affaiblira tous, car qui d'autre que le roi-liche pourrait beneficier d'une telle folie?? De grands guerriers ont perdu la vie. Et pour quoi?? La vraie menace plane à l'horizon?: le roi-liche nous attend, tous, dans la mort."
...
_L.yells[604]["Icecrown Gunship Battle Horde"] =
    "L'Alliance baisse pavillon. Sus au roi-liche !"

-- Yells/Ruby_Sanctum
_L.yells[609]["Halion"] =
    "Savourez bien cette victoire mortels car ce serra votre dernière. Ce monde brulera au retour du maitre !"

-- Yells/Throne_of_the_Four_Winds
_L.yells[773]["Conclave Of Wind"] =
    "Le conclave du Vent est dissipé. Votre conduite honorable et votre détermination vous valent le droit de m'affronter, mortels. J'attends votre attaque sur ma plate-forme ! Venez !"
...
_L.yells[886]["Lei Shi"] =
    "Je… ah… oh ! J’ai… ? Tout était… si… embrouillé."
_L.yells[886]["Tsulong"] = "Je vous remercie, étrangers. J'ai été libéré."

-- Yells/Siege_of_Orgrimmar
_L.yells[953]["Immerseus"] =
    "Ah, vous avez réussi ! Les eaux ont retrouvé leur pureté."
_L.yells[953]["Spoils of Pandaria"] =
    "Système en cours de réinitialisation. Veuillez ne pas le débrancher, ou il pourrait vous sauter à la figure."
...
MRT_L.Core["Export_AttendanceNote"] =
    [=[Dans le Raid-Log-Import-Settings, s'il vous plaît définir l'option
...
MRT_L.Core["Export_Explanation"] =
    [=[Ctrl+C pour copier les données vers le presse-papier
...
MRT_L.Core["GuildAttendanceAddNotice"] =
    "%s a ajouté %s à la liste des participants."
MRT_L.Core["GuildAttendanceAnnounceText"] =
    "Wispez moi les noms de vos mains pour être ajoutés à la liste DKP."
MRT_L.Core["GuildAttendanceAnnounceText2"] =
    "Whisp moi avec '%s' pour être ajouter à la liste DKP"
...
MRT_L.Core["GuildAttendanceFailNotice"] =
    "%s n'a pas pu ajouté %s à la liste des participants."
MRT_L.Core["GuildAttendanceMsgBox"] =
    "%s down. Faire une vérification des présences?"
...
MRT_L.Options["AP_GroupRestriction"] =
    "Suivre simplement les 2 premiers groupes (sur 5)"
MRT_L.Options["AP_GuildAttendance"] =
    "Activer la vérification des participants de la guilde"
MRT_L.Options["AP_GuildAttendanceCustomTextTitle"] =
    "Texte personnalisé pour la présence de guilde :"
MRT_L.Options["AP_GuildAttendanceDuration"] =
    "Durée de prise en compte des participants"
...
MRT_L.Options["EP_TitleText"] = " Option d'exportation"
...
MRT_L.Options["TP_CreateNewRaidOnNewZone"] =
    "Créer un nouveau raid en entrant dans une nouvelle zone"
MRT_L.Options["TP_Log10MenRaids"] = "Suivre les raids de 10 joueurs"
MRT_L.Options["TP_LogAVRaids"] =
    "Suivre les raids JcJ (Archavon, Bastion de Baradin)"
--[[Translation missing --]]
...
MRT_L.Options["TP_MinItemQualityToGetCost_Desc"] =
    "Qualité minimum des objets à valoriser"
MRT_L.Options["TP_MinItemQualityToLog_Desc"] =
    "Qualité minimum des objets à suivre"
MRT_L.Options["TP_OnlyTrackItemsAbove"] =
    [=[Sauvegarder seulement des objets
...
MRT_L.Options["TP_TitleText"] = " Options du suivi des raids"
...
MRT_L.Options["TT_EP_AddPoorItem"] =
    [=[Cette option change un peu l'export des loots pour corriger la détection de rencontre de boss
...
MRT_L.Options["TT_EP_RLIAttendanceFix"] =
    [=[Cette option modifies un peu l'export des horodatages pour
...
MRT_L.GUI["Active raid found. End current one first."] =
    "Erreur : Raid actif trouvé. Merci de clôturer ce raid avant d'en démarrer un nouveau."
...
MRT_L.GUI["Can not delete current raid"] =
    "Erreur : Impossible de supprimer le raid actuel."
...
MRT_L.GUI["Confirm boss attendee entry deletion"] =
    "Voulez-vous supprimer %s de la liste des participants sur ce boss ?"
MRT_L.GUI["Confirm boss entry deletion"] =
    "Voulez-vous supprimer l'entrée %d - %s de la liste des boss tués ?"
MRT_L.GUI["Confirm loot entry deletion"] =
    "Voulez-vous supprimer l'objet %s de la liste des loots ?"
MRT_L.GUI["Confirm raid attendee entry deletion"] =
    "Voulez-vous supprimer %s de la liste des participants du raid ?"
MRT_L.GUI["Confirm raid entry deletion"] =
    "Voulez-vous supprimer le raid numéro %d ?"
MRT_L.GUI["Difficulty N or H"] = "Difficulté ('N' ou 'H')"
MRT_L.GUI["End tracking of current raid before exporting it"] =
    "Erreur : Impossible d'exporter un raid actif."
MRT_L.GUI["Entered join time is not before leave time"] =
    "Erreur : L'heure d'entrée ne précède pas l'heure de sortie."
MRT_L.GUI["Entered time is not between start and end of raid"] =
    "Erreur : l'heure saisie n'est pas comprise entre le début et la fin du raid."
MRT_L.GUI["Header_Title"] = " Log des Raids"
MRT_L.GUI["Item cost invalid"] =
    "Erreur : le coût de l'objet n'est pas un nombre."
...
MRT_L.GUI["No active raid in progress. Please enter time."] =
    "Erreur : Pas de raid actif en cours. SVP entrer une heure."
MRT_L.GUI["No active raid."] = "Erreur : Pas de raid actif."
MRT_L.GUI["No boss attendee selected"] =
    "Erreur : Pas de participant sur le boss sélectionné"
...
MRT_L.GUI["TT_BA_Add"] =
    "Ajouter un participant la la liste des participants sur ce boss."
...
MRT_L.GUI["TT_RA_Add"] =
    "Ajouter un participant à la liste des participants du raid."
...
MRT_L.GUI["TT_Raid_ExportH"] =
    "Exporter toutes les rencontres en mode héroïque du raid sélectionné."
MRT_L.GUI["TT_Raid_ExportN"] =
    "Exporter toutes les rencontres en mode normal du raid sélectionné."
MRT_L.GUI["TT_StartNewRaid_RaidSizeEB"] =
    "Si laissé vide, MRT utilisera 25 comme valeur par défaut."
MRT_L.GUI["TT_StartNewRaid_ZoneNameEB"] =
    "Si laissé vide, MRT utilisera le nom de la zone actuelle."
MRT_L.GUI["TT_TakeSnapshot"] =
    [=[Prendre un instantané du groupe de raid actuel.
