...
_L.yells[529]["Algalon"] =
    "나는 창조주의 불길이 씻어내린 세상을 보았다. 모두 변변히 저항도 못하고 사그라졌지. 너희 필멸자의 심장이 단 한번 뛸 시간에 전 행성계가 탄생하고 무너졌다. 그러나 그 모든 시간 동안, 나는 공감이란 감정을... 몰랐다. 나는, 아무것도, 느끼지, 못했다. 무수한, 무수한 생명이 꺼졌다. 그들이 모두 너희처럼 강인했더냐? 그들이 모두 너희처럼 삶을 사랑했단 말이냐?"
_L.yells[529]["Freya"] =
    "내게서 그의 지배력이 걷혔다. 다시 온전한 정신을 찾았도다. 영웅들이여, 고맙다."
_L.yells[529]["Hodir"] =
    "드디어... 드디어 그의 손아귀를... 벗어나는구나."
_L.yells[529]["Mimiron"] =
    "내가 계산을 좀 잘못한 것 같군. 감옥에 갇힌 마귀가 내 마음을 타락시키고 제1지시를 재정의하고 말았다. 이제 모든 시스템이 제 기능을 찾았다. 정상이다."
...
_L.yells[604]["Icecrown Gunship Battle Alliance"] =
    "악당 놈들, 분명히 경고했다! 형제자매여, 전진!"
_L.yells[604]["Icecrown Gunship Battle Horde"] =
    "얼라이언스는 기가 꺾였다. 리치 왕을 향해 전진하라!"
...
_L.yells[773]["Conclave Of Wind"] =
    "바람의 비밀의회가 패배했군. 필멸자들이여, 너희의 명예로운 전투와 투지가 가상하여 나를 직접 상대할 기회를 주겠다. 내 너희의 공격을 기다리고 있다! 오너라!"
...
MRT_L.Options["EP_TitleText"] = " 내보내기 설정"
...
MRT_L.Options["ITP_TitleText"] = " 아이템 추적 옵션"
...
MRT_L.Options["TP_TitleText"] = " 추적 설정"
...
MRT_L.Options["TT_EP_AddPoorItem"] =
    [=[This option changes the loot export a bit to fix the boss encounter detection
...
MRT_L.GUI["Active raid found. End current one first."] =
    "오류: 활성화중인 공격대를 찾았습니다. 새로운 공격대를 시작하기전에 활성화중인 공격대를 종료하세요."
...
MRT_L.GUI["TT_Raid_ExportH"] =
    "선택된 공격대의 영웅 모드의 교전을 내보냅니다."
MRT_L.GUI["TT_Raid_ExportN"] =
    "선택된 공격대의 일반 모드의 교전을 내보냅니다."
MRT_L.GUI["TT_StartNewRaid_RaidSizeEB"] =
    "만약 좌측을 비우면 MRT 에서 25 기본값을 사용합니다."
MRT_L.GUI["TT_StartNewRaid_ZoneNameEB"] =
    "만약 빈공간이면 MRT에서 당신의 현재 지역을 사용합니다."
