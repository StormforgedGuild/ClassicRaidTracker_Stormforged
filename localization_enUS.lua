...
MRT_L.Core["Import_Explanation"] =
    [=[Copy PR Import String from https://stormforged.org.
Press Ctrl+V to paste PR export into window & press the Import Button.]=]
...
MRT_L.GUI["Button_EndCurrentRaid"] = "End\nRaid"
