...
MRT_L.Core["Import_Button"] = "Import"
...
MRT_L.Core["Import_Explanation"] =
    [=[Copy (Ctrl+C) PR Import String from the webite URL below.
Paste (Ctrl+V) into the window below & press the Import Button.]=]
...
MRT_L.Core["GuildAttendanceAnnounceText"] =
    "Whisper me your mains name to be added to the DKP list."
...
MRT_L.Core["TakeSnapshot_NotInRaidError"] =
    "Error: You are not in a raid. No snapshot taken."
...
MRT_L.Options["AP_TitleText"] = "Attendance options"
...
MRT_L.Options["EP_CTRT_compatible"] =
    "EQdkp / MLdkp 1.1 (CT RaidTracker compatible)"
...
MRT_L.Options["EP_TitleText"] = "Export options"
...
MRT_L.Options["ITP_SyncWML"] = "Sync loot with Master Looter"
...
MRT_L.Options["TP_MinItemQualityToGetCost_Desc"] =
    "Min item quality to ask cost for"
...
MRT_L.Options["TP_TitleText"] = "Raid tracking options"
...
MRT_L.GUI["Active raid found. End current one first."] =
    "Error: Active raid found. Please end the active raid before starting a new one."
...
MRT_L.GUI["Button__Small_Add"] = "+"
MRT_L.GUI["TT_Small_Add"] = "Start Raid"
MRT_L.GUI["Button__Small_Delete"] = "-"
MRT_L.GUI["Button_Delete"] = "Delete"
MRT_L.GUI["Button_Delete_Raid"] = "-"
MRT_L.GUI["Button_Import_PR"] = "Import"
MRT_L.GUI["Button_EndCurrentRaid"] = "x"
MRT_L.GUI["TT_EndCurrentRaid"] = "End Current Raid"
...
MRT_L.GUI["Button_Modify"] = "Edit"
MRT_L.GUI["Button_ResumeLastRaid"] = "Resume"
MRT_L.GUI["Button_StartNewRaid"] = "+"
MRT_L.GUI["Button_TakeSnapshot"] = "Snapshot"
...
MRT_L.GUI["Confirm boss attendee entry deletion"] =
    "Do you want to delete %s from the boss attendees list?"
MRT_L.GUI["Confirm boss entry deletion"] =
    "Do you want to delete entry %d - %s - from the bosskill list?"
MRT_L.GUI["Confirm loot entry deletion"] =
    "Do you want to delete item %s from the loot list?"
MRT_L.GUI["Confirm raid attendee entry deletion"] =
    "Do you want to delete %s from the raid attendees list?"
MRT_L.GUI["Confirm raid entry deletion"] =
    "Do you want to delete raid number %d?"
MRT_L.GUI["Difficulty N or H"] = "Difficulty ('N' or 'H')"
MRT_L.GUI["End tracking of current raid before exporting it"] =
    "Error: Can't export active raid."
...
MRT_L.GUI["Invalid Player"] = "Error: looter name is not in the raid."
...
MRT_L.GUI["TT_RA_GroupBy"] = "Group Attendee list by class"
...
MRT_L.GUI["TT_Raid_ExportN"] =
    "Export all normal mode encounters of selected raid."
MRT_L.GUI["TT_StartNewRaid_RaidSizeEB"] =
    "If left blank, MRT will use 25 as the default value."
MRT_L.GUI["TT_StartNewRaid_ZoneNameEB"] =
    "If left blank, MRT will use your current zone."
