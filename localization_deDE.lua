...
_L.yells[529]["Freya"] =
    "Seine Macht über mich beginnt zu schwinden. Endlich kann ich wieder klar sehen. Ich danke Euch, Helden."
_L.yells[529]["Hodir"] = "Ich... bin von ihm befreit... endlich."
_L.yells[529]["Mimiron"] =
    "Es scheint, als wäre mir eine klitzekleine Fehlkalkulation unterlaufen. Ich habe zugelassen, dass das Scheusal im Gefängnis meine Primärdirektive überschreibt. Alle Systeme nun funktionstüchtig."
_L.yells[529]["Thorim"] = "Senkt Eure Waffen! Ich ergebe mich!"

-- Yells/Trials_of_the_Crusader
_L.yells[543]["Faction Champions"] =
    "Ein tragischer Sieg. Wir wurden schwächer durch die heutigen Verluste. Wer außer dem Lichkönig profitiert von solchen Torheiten? Große Krieger gaben ihr Leben. Und wofür? Die wahre Bedrohung erwartet uns noch - der Lichkönig erwartet uns alle im Tod."

-- Yells/Icecrown_Citadel
_L.yells[604]["Dreamwalker"] =
    "ICH BIN GEHEILT! Ysera, erlaubt mir, diese üblen Kreaturen zu beseitigen!"
_L.yells[604]["Icecrown Gunship Battle Alliance"] =
    "Sagt nicht, ich hätte Euch nicht gewarnt, Ihr Schurken! Vorwärts, Brüder und Schwestern!"
_L.yells[604]["Icecrown Gunship Battle Horde"] =
    "Die Allianz wankt. Vorwärts zum Lichkönig!"

-- Yells/Ruby_Sanctum
_L.yells[609]["Halion"] =
    "Genießt euren Sieg, Sterbliche, denn es war euer letzter. Bei der Rückkehr des Meisters wird diese Welt brennen!"

-- Yells/Throne_of_the_Four_Winds
_L.yells[773]["Conclave Of Wind"] =
    "Das Konklave des Windes hat sich aufgelöst. Euer ehrenvolles Betragen sowie eure Entschlossenheit haben euch das Recht verschafft, mir in der Schlacht gegenüberzutreten, Sterbliche. Ich erwarte Euren Angriff auf meiner Plattform! Kommt!"
...
_L.yells[886]["Lei Shi"] =
    "Ich... ah... oh! Hab ich...? War ich...? Es war... so... trüb."
_L.yells[886]["Tsulong"] = "Ich danke Euch, Fremdlinge. Ich wurde befreit."

-- Yells/Siege_of_Orgrimmar
_L.yells[953]["Immerseus"] =
    "Ah, Ihr habt es geschafft! Das Wasser ist wieder rein."
_L.yells[953]["Spoils of Pandaria"] =
    "System wird neu gestartet. Die Energieversorgung muss stabil bleiben, sonst fliegt die ganze Chose in die Luft."
...
MRT_L.Core["Export_AttendanceNote"] =
    [=[Setze bitte den Wert der Raid-Log-Import Einstellung
...
MRT_L.Core["Export_Explanation"] =
    [=[Drücke Strg+C, um die Daten in die Zwischenablage zu kopieren.
...
MRT_L.Core["GuildAttendanceAddNotice"] =
    "%s hat %s zur Bossteilnehmerliste hinzugefügt."
MRT_L.Core["GuildAttendanceAnnounceText"] =
    "Flüstert mir den Namen eures Mainchars, um zur DKP-Liste hinzugefügt zu werden."
MRT_L.Core["GuildAttendanceAnnounceText2"] =
    "Flüstert mir '%s', um zur DKP-Liste hinzugefügt zu werden."
...
MRT_L.Core["GuildAttendanceFailNotice"] =
    "%s versuchte vergeblich %s in die Boss-Teilnehmerliste einzutragen."
MRT_L.Core["GuildAttendanceMsgBox"] =
    "%s down. Soll jetzt ein Teilnehmer-Check durchgeführt werden?"
...
MRT_L.Options["AP_GuildAttendanceCustomTextTitle"] =
    "Eigener Text für den Gilden-Teilnehmer-Check:"
...
MRT_L.Options["AP_GuildAttendanceUseCustomText"] =
    "Benutze eigenen Text für den Gilden-Teilnehmer-Check"
MRT_L.Options["AP_GuildAttendanceUseTrigger"] =
    "Benutze einen Trigger anstelle des Charakternamens"
MRT_L.Options["AP_Minutes"] = "Minuten"
MRT_L.Options["AP_Title"] = "Teilnehmer"
MRT_L.Options["AP_TitleText"] = "Classic Teilnehmer-Optionen"
...
MRT_L.Options["EP_BBCode_wowhead"] =
    "BBCode formatierter Text mit wowhead Links"
...
MRT_L.Options["EP_CTRT_compatible"] =
    "EQdkp / MLdkp 1.1 (CT RaidTracker kompatibel)"
MRT_L.Options["EP_CTRT_IgnorePerBossAttendance"] =
    "Ignoriere Anwesenheit pro Boss"
MRT_L.Options["EP_CTRT_RLIAttendanceFix"] =
    [=[Aktiviere Anwesenheits-Fix für den
...
MRT_L.Options["EP_EnglishExport"] =
    "Exportiere Instanz- und Bossnamen auf Englisch"
...
MRT_L.Options["EP_TitleText"] = "RaidTracker - Export-Optionen"
...
MRT_L.Options["ITP_AutoFocus_Title"] =
    "Automatischer Fokus auf das Loot-Kosten-Fenster"
...
MRT_L.Options["ITP_TitleText"] = "RaidTracker - Item-Tracking-Einstellungen"
MRT_L.Options["ITP_UseEPGP_GP_Values"] = "Benutze EPGP GP Werte"
MRT_L.Options["MP_AutoPrunning"] =
    "Lösche automatisch alle Raids, die älter sind als"
...
MRT_L.Options["TP_AskForDKPValuePersonal"] =
    "... auch im persönlichen Plündermodus"
MRT_L.Options["TP_CreateNewRaidOnNewZone"] =
    "Erstelle einen neuen Raid nach einem Zonenwechsel."
...
MRT_L.Options["TP_MinItemQualityToGetCost_Desc"] =
    "Min. Itemqualität für die nach Kosten gefragt wird"
MRT_L.Options["TP_MinItemQualityToLog_Desc"] =
    "Min. Itemqualität die getrackt wird"
MRT_L.Options["TP_OnlyTrackItemsAbove"] =
    "Tracke nur Items mit Itemlevel gleich oder höher"
MRT_L.Options["TP_OnlyTrackItemsBelow"] =
    "oder mit Itemlevel gleich oder kleiner"
MRT_L.Options["TP_Title"] = "Raid Tracking"
MRT_L.Options["TP_TitleText"] = "Classic Raid-Tracking-Einstellungen"
...
MRT_L.Options["TT_EP_AddPoorItem"] =
    [=[Diese Option ändert den Itemexport ein wenig, um die Bosserkennung
...
MRT_L.Options["TT_EP_RLIAttendanceFix"] =
    [=[Diese Option ändert den Export der Zeitstempel ein wenig um die
...
MRT_L.GUI["Active raid found. End current one first."] =
    "Fehler: Aktiven Raid gefunden. Bitte beende den aktuellen Raid, bevor du einen neuen startest."
...
MRT_L.GUI["Can not delete current raid"] =
    "Fehler: Kann laufenden Raid nicht löschen."
...
MRT_L.GUI["Confirm boss attendee entry deletion"] =
    "Willst du %s von der Bossteilnehmerliste löschen?"
MRT_L.GUI["Confirm boss entry deletion"] =
    "Willst du den Eintrag %d - %s - von der Bosskillliste löschen?"
MRT_L.GUI["Confirm loot entry deletion"] =
    "Willst du %s von der Lootliste löschen?"
MRT_L.GUI["Confirm raid attendee entry deletion"] =
    "Willst du %s von der Raidteilnehmerliste löschen?"
...
MRT_L.GUI["End tracking of current raid before exporting it"] =
    "Fehler: Der aktive Raid kann nicht exportiert werden."
MRT_L.GUI["Entered join time is not before leave time"] =
    "Fehler: Eingegebene Startzeit ist nicht vor der Endzeit."
MRT_L.GUI["Entered time is not between start and end of raid"] =
    "Fehler: Eingegebene Zeit liegt nicht zwischen dem Start und dem Ende des Raids."
...
MRT_L.GUI["No active raid in progress. Please enter time."] =
    "Fehler: Kein aktiver Raid. Bitte gib eine Uhrzeit an."
MRT_L.GUI["No active raid."] = "Fehler: Kein aktiver Raid."
MRT_L.GUI["No boss attendee selected"] =
    "Fehler: Kein Bossteilnehmer ausgewählt."
...
MRT_L.GUI["No raid attendee selected"] =
    "Fehler: Kein Raidteilnehmer ausgewählt."
MRT_L.GUI["No raid selected"] = "Fehler: Kein Raid ausgewählt."
MRT_L.GUI["No valid difficulty entered"] =
    "Fehler: Kein gültiger Wert für die Schwierigkeit eingegeben."
MRT_L.GUI["No valid raid size"] =
    "Fehler: Keine gültiger Wert für die Raidgröße angegeben."
...
MRT_L.GUI["Resuming last raid failed"] =
    "Fehler: Die Fortsetzung des letzten Raids ist fehlgeschlagen."
MRT_L.GUI["Resuming last raid successful"] =
    "Der letzte Raid wird nun fortgesetzt..."
...
MRT_L.GUI["TT_BA_Add"] =
    "Fügt einen Teilnehmer zur Bossteilnehmer-Liste hinzu."
...
MRT_L.GUI["TT_RA_Add"] =
    "Füge einen Teilnehmer zur Raidteilnehmer-Liste hinzu."
...
MRT_L.GUI["TT_Raid_ExportH"] =
    "Exportiere alle heroischen Bosse des ausgewählten Raids."
MRT_L.GUI["TT_Raid_ExportN"] =
    "Exportiere alle normalen Bosse des ausgewählten Raids."
MRT_L.GUI["TT_StartNewRaid_RaidSizeEB"] =
    "Ohne Eingabe benutzt MRT 25 als den Standardwert."
MRT_L.GUI["TT_StartNewRaid_ZoneNameEB"] =
    "Ohne Eingabe benutzt MRT deine momentane Zone."
MRT_L.GUI["TT_TakeSnapshot"] =
    [=[Eine Aufnahme des momentanen Schlachtzugs machen.
