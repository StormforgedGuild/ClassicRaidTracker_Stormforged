...
if (not ClassicRaidTracker) then return end
...
-----------------
-- Yells/Ulduar
_L.yells[529]["Algalon"] =
    "Já vi mundos banhados pelas chamas dos Criadores, seus habitantes desaparecendo sem sequer um gemido. Sistemas planetários inteiros nascem e são destruídos no tempo que leva para seus corações mortais para baterem uma vez. No entanto, durante todo o tempo, meu coração desprovido de emoção ... de empatia. Eu. Sinto. Nada. Um milhão de vidas desperdiçadas. Todos eles tinham dentro de si a sua tenacidade? Todos eles amavam a vida como você?"
_L.yells[529]["Freya"] =
    "Seu domínio sobre mim se dissipa. Eu posso ver claramente mais uma vez. Obrigado heróis."
_L.yells[529]["Hodir"] = "Eu... Eu estou livre do seu alcance... finalmente."
_L.yells[529]["Mimiron"] =
    "Parece que cometi um ligeiro erro de cálculo. Eu permiti que minha mente fosse corrompida pelo demônio na prisão, anulando minha diretiva primária. Todos os sistemas parecem estar funcionais agora. Livre."
_L.yells[529]["Thorim"] = "Baixem as armas! Eu me rendo!"

-- Yells/Trials_of_the_Crusader
_L.yells[543]["Faction Champions"] =
    "Uma vitória superficial e trágica. Somos mais fracos como um todo pelas perdas sofridas hoje. Quem, a não ser o Lich King, poderia se beneficiar dessa tolice? Grandes guerreiros perderam suas vidas. E para quê? A verdadeira ameaça está à frente - o Lich Rei nos aguarda na morte."
...
_L.yells[604]["Icecrown Gunship Battle Alliance"] =
    "Não digam que eu não avisei, canalhas! Avante, irmãos e irmãs!"
_L.yells[604]["Icecrown Gunship Battle Horde"] =
    "A Aliança vacila. Avante ao Lich Rei!"

-- Yells/Ruby_Sanctum
_L.yells[609]["Halion"] =
    "Aprecie esta vitória, mortais, pois será a última. Este mundo vai queimar com o retorno do mestre!"

-- Yells/Throne_of_the_Four_Winds
_L.yells[773]["Conclave Of Wind"] =
    "O Conclave do Vento se dissipou. Sua conduta e determinação honrosas lhe valeram o direito de enfrentar-me em batalha, mortais. Aguardo seu ataque na minha plataforma! Venham!"

-- Yells/Firelands
_L.yells[800]["Ragnaros"] = "Cedo demais! ... Vocês vieram cedo demais ..."

-- Yells/Terrace_of_Endless_Spring
_L.yells[886]["Lei Shi"] =
    "Eu... ah... oh! Eu fiz ...? Eu estava...? Estava... tão... turvo..."
_L.yells[886]["Tsulong"] = "Eu agradeço, estranhos. Eu fui libertado."

-- Yells/Siege_of_Orgrimmar
_L.yells[953]["Immerseus"] =
    "Ah, você conseguiu! As águas são puras mais uma vez."
_L.yells[953]["Spoils of Pandaria"] =
    "Sistema reiniciando. Não desligue a energia, ou a coisa toda provavelmente explodirá."

-- Yells/Hellfire_Citadel
_L.yells[1026]["Hellfire Assault"] =
    "Se você quer que algo fique bem feito, então faça você mesmo..."
...
MRT_L.Core["Export_AttendanceNote"] =
    [=[Em "Raid-Log-Import-Settings", por favor, selecione a opção:
...
MRT_L.Core["GuildAttendanceAddNotice"] =
    "%s adicionado %s na lista de participantes do chefe."
MRT_L.Core["GuildAttendanceAnnounceText"] =
    "Sussurre-me o nome do seu personagem principal para ser adicionado à lista DKP."
MRT_L.Core["GuildAttendanceAnnounceText2"] =
    "Sussurre-me com '%s' para ser adicionado à lista DKP."
MRT_L.Core["GuildAttendanceBossDownText"] = "%s derrotado!"
MRT_L.Core["GuildAttendanceBossEntry"] = "Verificação de frequência"
MRT_L.Core["GuildAttendanceFailNotice"] =
    "%s falhou em adicionar %s à lista de participantes."
MRT_L.Core["GuildAttendanceMsgBox"] =
    "%s derrotado. Realizar verificação de frequência agora?"
...
MRT_L.Core["GuildAttendanceTimeUpText"] =
    "Se você não me sussurrou, agora é tarde demais."
MRT_L.Core["LDB Left-click to toggle the raidlog browser"] =
    "Clique com o botão esquerdo para alternar o navegador de \"raidlog\""
MRT_L.Core["LDB Right-click to open the options menu"] =
    "Clique com o botão direito para abrir o menu de opções"
MRT_L.Core["MB_Cancel"] = "Cancelar"
MRT_L.Core["MB_No"] = "Não"
MRT_L.Core["MB_Ok"] = "Ok"
MRT_L.Core["MB_Yes"] = "Sim"
MRT_L.Core["TakeSnapshot_CurrentRaidError"] =
    "Erro: Raide ativa ainda em progresso. Nenhum \"snapshot\" feito."
MRT_L.Core["TakeSnapshot_Done"] = "\"Snapshot\" feito."
MRT_L.Core["TakeSnapshot_NotInRaidError"] =
    "Erro: Você não está em raid. Nenhum \"snapshot\" feito."
...
MRT_L.Options["AP_GroupRestriction"] =
    "Acompanhar apenas os primeiros 2/4/5/6 grupos"
MRT_L.Options["AP_GuildAttendance"] =
    "Ativar verificação de freqüência da guilda"
MRT_L.Options["AP_GuildAttendanceCustomTextTitle"] =
    "Texto de freqüência da guilda personalizado:"
MRT_L.Options["AP_GuildAttendanceDuration"] =
    "Duração para realizar freqüência"
...
MRT_L.Options["AP_GuildAttendanceUseCustomText"] =
    "Usar texto de freqüência da guilda personalizado"
MRT_L.Options["AP_GuildAttendanceUseTrigger"] =
    "Usar o gatilho em vez do nome do personagem"
MRT_L.Options["AP_Minutes"] = "minutos"
MRT_L.Options["AP_Title"] = "Freqüência"
MRT_L.Options["AP_TitleText"] = " Opções de comparecimento"
...
MRT_L.Options["EP_EnglishExport"] =
    "Exportar nomes de zonas e nomes de chefes em inglês"
...
MRT_L.Options["EP_TextExportTitleText"] =
    "Configurações de exportação de texto"
MRT_L.Options["EP_Title"] = "Exportar"
MRT_L.Options["EP_TitleText"] = " opções de exportação"
...
MRT_L.Options["ITP_AutoFocus_Title"] =
    "Foco automático na janela de custo do saque"
...
MRT_L.Options["ITP_TitleText"] = " Opções de rastreamento de itens"
MRT_L.Options["ITP_UseEPGP_GP_Values"] = "Use os valores de GP do EPGP"
MRT_L.Options["MP_AutoPrunning"] =
    "Excluir automaticamente raids mais antigas que"
...
MRT_L.Options["TP_AskForDKPValuePersonal"] =
    "... se o modo de saque for \"pessoal\""
...
MRT_L.Options["TP_MinItemQualityToGetCost_Desc"] =
    "Qualidade mínima do item para pedir custo"
MRT_L.Options["TP_MinItemQualityToLog_Desc"] =
    "Qualidade mínima do item para registrar (log)"
MRT_L.Options["TP_OnlyTrackItemsAbove"] =
    "Rastrear apenas itens de item level igual ou acima"
MRT_L.Options["TP_OnlyTrackItemsBelow"] = "Item level igual ou inferior"
MRT_L.Options["TP_Title"] = "Rastreamento de raide"
MRT_L.Options["TP_TitleText"] = " Opções de rastreamento de raide"
...
MRT_L.Options["TT_EP_AddPoorItem"] =
    [=[Esta opção altera um pouco a exportação de saque para corrigir a detecção
...
MRT_L.Options["TT_EP_DateTimeTT"] = [=[ %d - dia do mês [01-31]
 ...
 %S - segundo [00-59]
 %p - ou 'am' ou 'pm']=]
MRT_L.Options["TT_EP_RLIAttendanceFix"] =
    [=[Esta opção altera um pouco a exportação de "timestamps" para passar
...
-------------------
-- MRT_L/GUI
MRT_L.GUI["Active raid found. End current one first."] =
    "Erro: Raide ativa encontrada. Por favor, finalize a raid ativa antes de começar uma nova."
...
MRT_L.GUI["Button_MakeGuildAttendanceCheck"] =
    "Faça verificação de comparecimento da guilda"
...
MRT_L.GUI["Can not delete current raid"] =
    "Erro: Não é possível excluir a raide corrente."
...
MRT_L.GUI["Confirm boss attendee entry deletion"] =
    "Você deseja excluir %s da lista de participantes do chefe?"
MRT_L.GUI["Confirm boss entry deletion"] =
    "Deseja excluir a entrada %d - %s - da lista de morte do chefe?"
MRT_L.GUI["Confirm loot entry deletion"] =
    "Deseja excluir o item %s da lista de saque?"
MRT_L.GUI["Confirm raid attendee entry deletion"] =
    "Você deseja excluir %s da lista de participantes da raide?"
MRT_L.GUI["Confirm raid entry deletion"] =
    "Você deseja excluir a raid de número %d?"
MRT_L.GUI["Difficulty N or H"] = "Dificuldade ('N' ou 'H')"
MRT_L.GUI["End tracking of current raid before exporting it"] =
    "Erro: Não é possível exportar a raide ativa."
MRT_L.GUI["Entered join time is not before leave time"] =
    "Erro: O tempo inserido de entrada não é antes do tempo de saída."
MRT_L.GUI["Entered time is not between start and end of raid"] =
    "Erro: O tempo inserido não está entre o início e o fim da raide."
MRT_L.GUI["Header_Title"] = " Log de raide"
...
MRT_L.GUI["No active raid in progress. Please enter time."] =
    "Erro: nenhuma raide ativa em andamento. Por favor insira o horário."
MRT_L.GUI["No active raid."] = "Erro: nenhuma raide ativa."
MRT_L.GUI["No boss attendee selected"] =
    "Erro: Nenhum participante do chefe foi selecionado."
...
MRT_L.GUI["No raid attendee selected"] =
    "Erro: Nenhum participante de raide selecionado."
MRT_L.GUI["No raid selected"] = "Error: Nenhuma raide foi selecionada."
MRT_L.GUI["No valid difficulty entered"] =
    "Erro: Nenhuma dificuldade válida inserida."
MRT_L.GUI["No valid raid size"] =
    "Erro: Nenhum tamanho de raide válido foi inserido."
MRT_L.GUI["No valid time entered"] = "Erro: Nenhum tempo válido inserido."
MRT_L.GUI["Note"] = "Nota"
MRT_L.GUI["Player not in raid."] =
    "Erro: Você não está em um grupo de raide."
MRT_L.GUI["Raid size"] = "Tamanho da raide"
MRT_L.GUI["Resuming last raid failed"] =
    "Erro: Não foi possível retomar a última raid"
MRT_L.GUI["Resuming last raid successful"] =
    "A última raid foi retomada com sucesso."
...
MRT_L.GUI["TT_BA_Add"] =
    "Adicionar um participante à lista de participantes do chefe."
...
MRT_L.GUI["TT_RA_Add"] =
    "Adicione um participante à lista de frequência da raide."
...
MRT_L.GUI["TT_Raid_ExportH"] =
    "Exportar todos os encontros do modo heróico da raide selecionada."
MRT_L.GUI["TT_Raid_ExportN"] =
    "Exportar todos os encontros do modo normal da raide selecionada."
MRT_L.GUI["TT_StartNewRaid_RaidSizeEB"] =
    "Se deixado em branco, o MRT usará 25 como o valor padrão."
MRT_L.GUI["TT_StartNewRaid_ZoneNameEB"] =
    "Se deixado em branco, o MRT usará sua zona atual."
MRT_L.GUI["TT_TakeSnapshot"] =
    [=[Faça uma "foto rápida" do grupo de raid corrente.
