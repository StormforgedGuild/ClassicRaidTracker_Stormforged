...
MRT_L.Options = {
    ...
    AP_Minutes = "minutes",
    AP_Title = "Attendance",
    AP_TitleText = " Attendance options",
...
EQdkp-Plus Raid-Log-Import 0.5.6.x]=],
    ...
    EP_Title = "Export",
    EP_TitleText = " Export options",
    ITP_Title = "Item tracking",
    ITP_TitleText = " Item tracking options",
    ...
    TP_TitleText = " Raid tracking options",
...
MRT_L.GUI = {
    ...
    ["RaidAnnounceMessage"] = "Type MS/OS if you want %s for %s GP",   
    ["RaidAnnounceMSOnlyMessage"] = "Type MS if you want %s for %s GP",   
    ["RaidTokenMessage"] = "This is the quest item for %s",
    ["RaidTokenMessageCont"] = "and %s",
    ["RaidLinkMessage"] = "%s for %s GP",
    ["RaidWinMessage"] = "Congratz! ...%s... receives %s for %s GP",   
    ["RaidWinToolTip"] = "%s... receives %s for %s GP",   
    ["BidLeaderMessage"] = "New Highest PR: {triangle}%s{triangle} (%s) - %s",
    ["BidLeadersMessage"] = "Tie at highest bidder: PR: %s {triangle}(%s %s %s){triangle}",
