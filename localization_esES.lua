...
_L.yells[886]["Lei Shi"] =
    "Yo... ah... ¿eh? ¿Yo he...? ¿Era yo...? Todo... estaba... turbio."
_L.yells[886]["Tsulong"] =
    "Gracias, forasteros. Me habéis liberado. / Gracias, forasteros. Me han liberado."
...
MRT_L.Core["Export_Explanation"] =
    [=[Pulsa Ctrl+C para copiar los datos al  portapapeles.
...
MRT_L.Core["GuildAttendanceAddNotice"] =
    "%s added %s to the boss attendee list."
MRT_L.Core["GuildAttendanceAnnounceText"] =
    "Susurrame el nombre de tu personake principal para ser añadido a la lista de DKP"
--[[Translation missing --]]
MRT_L.Core["GuildAttendanceAnnounceText2"] =
    "Whisper me with '%s' to be added to the DKP list."
...
MRT_L.Core["GuildAttendanceFailNotice"] =
    "%s failed to add %s to the boss attendee list."
MRT_L.Core["GuildAttendanceMsgBox"] =
    "%s caido. ¿Realizar comprobación de asistencia ahora?"
...
MRT_L.Options["AP_GuildAttendance"] =
    "Habilitar comprobación de asistencia de hermandad"
--[[Translation missing --]]
MRT_L.Options["AP_GuildAttendanceCustomTextTitle"] =
    "Custom guild attendance text:"
MRT_L.Options["AP_GuildAttendanceDuration"] =
    "Duracion de recepcion de asistentes"
...
MRT_L.Options["AP_GuildAttendanceUseCustomText"] =
    "Use custom guild attendance text"
--[[Translation missing --]]
MRT_L.Options["AP_GuildAttendanceUseTrigger"] =
    "Use trigger instead of character name"
MRT_L.Options["AP_Minutes"] = "Minutos"
MRT_L.Options["AP_Title"] = "Asistente"
MRT_L.Options["AP_TitleText"] = " Opciones de asistencia"
...
MRT_L.Options["EP_CTRT_AddPoorItem"] =
    [=[Añadir un objero de bajo nivel a cada boss
...
MRT_L.Options["EP_TextExportTitleText"] =
    "Configuración de exportación de texto"
MRT_L.Options["EP_Title"] = "Exportar"
MRT_L.Options["EP_TitleText"] = " Opciones de exportación"
--[[Translation missing --]]
...
--[[Translation missing --]]
MRT_L.Options["ITP_TitleText"] = " Item tracking options"
--[[Translation missing --]]
...
MRT_L.Options["TP_CreateNewRaidOnNewZone"] =
    "Crear una nueva raid en una nueva zona."
...
MRT_L.Options["TP_MinItemQualityToGetCost_Desc"] =
    "Nivel minimo del objeto para preguntar por el coste"
MRT_L.Options["TP_MinItemQualityToLog_Desc"] =
    "Nivel minimo del objeto para registrar"
--[[Translation missing --]]
MRT_L.Options["TP_OnlyTrackItemsAbove"] =
    "Only track items equal or above Itemlevel"
--[[Translation missing --]]
MRT_L.Options["TP_OnlyTrackItemsBelow"] = "or equal or below Itemlevel"
MRT_L.Options["TP_Title"] = "Seguimiento"
MRT_L.Options["TP_TitleText"] = " Opciones de seguimiento"
...
MRT_L.GUI["Active raid found. End current one first."] =
    "Error: Raid ativa no encontrada. Por favor finalizar la raid actual antes de empezar una nueva."
...
MRT_L.GUI["Can not delete current raid"] =
    "Error: No se puede borrar la raid actual"
...
MRT_L.GUI["Confirm boss attendee entry deletion"] =
    "¿Quieres borrar a %s de la lista de asistentes?"
MRT_L.GUI["Confirm boss entry deletion"] =
    "¿Quieres borrar la entrada %d - %s - de la lista de bosskills?"
MRT_L.GUI["Confirm loot entry deletion"] =
    "¿Quieres borrar el objeto %s de la lista de botín?"
MRT_L.GUI["Confirm raid attendee entry deletion"] =
    "¿Quieres borrar al asistente %s de la lista de asistentes a raid?"
MRT_L.GUI["Confirm raid entry deletion"] =
    "¿Quieres borrar a la raid número %d?"
MRT_L.GUI["Difficulty N or H"] = "Dificultad ('N' o 'H')"
MRT_L.GUI["End tracking of current raid before exporting it"] =
    "Error: No se puede exportar la raid activa."
--[[Translation missing --]]
MRT_L.GUI["Entered join time is not before leave time"] =
    "Error: Entered join time is not before leave time."
MRT_L.GUI["Entered time is not between start and end of raid"] =
    "Error: El tiempo introducido no esta entre el principio y fin de raid."
MRT_L.GUI["Header_Title"] = " Log de raid"
...
MRT_L.GUI["No active raid in progress. Please enter time."] =
    "No hay raid activa en progreso. Por favor introduzca un tiempo."
...
MRT_L.GUI["TT_BA_Add"] =
    "Añadir un asistente a la lista de asistentes al boss."
...
MRT_L.GUI["TT_Raid_ExportH"] =
    "Exportar todos los encuentros heroicos de la raid seleccionada."
MRT_L.GUI["TT_Raid_ExportN"] =
    "Exportar todos los encuentros normales de la raid seleccionada."
MRT_L.GUI["TT_StartNewRaid_RaidSizeEB"] =
    "Si lo dejas en blanco, MRT usará tu zona actual."
MRT_L.GUI["TT_StartNewRaid_ZoneNameEB"] =
    "Si lo dejas en blanco, MRT utilizará la zona actual"
