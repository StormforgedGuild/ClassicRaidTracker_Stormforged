...
_L.yells[529]["Algalon"] =
    "我曾经看过尘世沉浸在造物者的烈焰之中，众生连一声悲泣都无法呼出，就此凋零。整个星系在弹指之间历经了毁灭与重生。然而在这段历程之中，我的心却无法感受到丝毫的…恻隐之念。我‧感‧受‧不‧到。成千上万的生命就这么消逝。他们是否拥有与你同样坚韧的生命?他们是否与你同样热爱生命?"
_L.yells[529]["Freya"] =
    "他对我的控制已经不复存在了。我又一次恢复了理智。谢谢你们，英雄们。"
_L.yells[529]["Hodir"] =
    "我……我终于从他的魔掌中……解脱了。"
...
MRT_L.Options["AP_TitleText"] = " 参与者选项"
...
MRT_L.Options["EP_CTRT_RLIAttendanceFix"] =
    "启用对于EQdkp-Plus Raid-Log-Import 0.5.6.3的团队成员修正"
...
MRT_L.Options["EP_TitleText"] = " 导出选项"
...
MRT_L.Options["ITP_TitleText"] = " 物品追踪选项"
--[[Translation missing --]]
...
MRT_L.Options["TP_TitleText"] = " 团队追踪选项"
...
MRT_L.GUI["Active raid found. End current one first."] =
    "错误: 找到进行中的团队事件，请在新建团队事件前结束当前团队事件"
...
MRT_L.GUI["Entered time is not between start and end of raid"] =
    "错误: 加入时间不在团队活动开始和结束之间"
MRT_L.GUI["Header_Title"] = " 团队记录"
