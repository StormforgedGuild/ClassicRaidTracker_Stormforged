...
_L.yells[529]["Algalon"] =
    "我曾經看過塵世沉浸在造物者的烈焰之中，眾生連一聲悲泣都無法呼出，就此凋零。整個星系在彈指之間歷經了毀滅與重生。然而在這段歷程之中，我的心卻無法感受到絲毫的…惻隱之念。我‧感‧受‧不‧到。成千上萬的生命就這麼消逝。他們是否擁有與你同樣堅韌的生命?他們是否與你同樣熱愛生命?"
_L.yells[529]["Freya"] =
    "他對我的操控已然退散。我已再次恢復神智了。感激不盡，英雄們。"
_L.yells[529]["Hodir"] = "我…我終於從他的掌控中…解脫了。"
_L.yells[529]["Mimiron"] =
    "看來我還是產生了些許計算錯誤。任由我的心智受到囚牢中魔鬼的腐化，棄我的首要職責於不顧。所有的系統看起來都正常運作。報告完畢。"
_L.yells[529]["Thorim"] = "住手!我認輸了!"

-- Yells/Trials_of_the_Crusader
_L.yells[543]["Faction Champions"] =
    "膚淺而悲痛的勝利。今天痛失的生命反而令我們更加的頹弱。除了巫妖王之外，誰還能從中獲利?偉大的戰士失去了寶貴生命。為了什麼?真正的威脅就在前方 - 巫妖王在死亡的領域中等著我們。"

-- Yells/Icecrown_Citadel
_L.yells[604]["Dreamwalker"] =
    "我重生了!伊瑟拉賦予我讓那些邪惡生物安眠的力量!"
_L.yells[604]["Icecrown Gunship Battle Alliance"] =
    "別說我沒警告過你，無賴!兄弟姊妹們，向前衝!"
_L.yells[604]["Icecrown Gunship Battle Horde"] =
    "聯盟已經動搖了。向巫妖王前進!"

-- Yells/Ruby_Sanctum
_L.yells[609]["Halion"] =
    "享受這場勝利吧，凡人們，因為這是你們最後一次的勝利。這世界將會在主人回歸時化為火海!"
...
MRT_L.Options["AP_TitleText"] = " 參與者選項"
...
MRT_L.Options["EP_CTRT_RLIAttendanceFix"] =
    "啟用對EQdkp-Plus Raid-Log-Import 0.5.6.x的團隊成員修正"
...
MRT_L.Options["EP_TitleText"] = " 匯出選項"
...
MRT_L.Options["ITP_TitleText"] = " 物品追蹤選項"
--[[Translation missing --]]
...
MRT_L.Options["TP_TitleText"] = " 追蹤選項"
...
MRT_L.Options["TT_EP_RLIAttendanceFix"] =
    [=[此選項略為修改了時間戳記的匯出以通過Raid-Log-Importer的50％門檻
...
MRT_L.GUI["Active raid found. End current one first."] =
    "錯誤:找到活動中的團隊事件.請在建立新事件之前結束活動中的團隊事件"
...
MRT_L.GUI["Entered time is not between start and end of raid"] =
    "錯誤:輸入的時間不在團隊開始與結束時間之內"
MRT_L.GUI["Header_Title"] = " 團隊記錄"
...
MRT_L.GUI["TT_StartNewRaid_RaidSizeEB"] =
    "如果保留空白, MRT 將會使用預設值25"
MRT_L.GUI["TT_StartNewRaid_ZoneNameEB"] =
    "如果保留空白, MRT 將會使用你現在的區域名稱"
